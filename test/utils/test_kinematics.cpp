...
TEMPLATE_LIST_TEST_CASE("Momentum", "[pT][p][kinematics]", ParticleTypes) {
  using namespace edm4hep;

  SECTION("pT: transverse momentum") {
    TestType particle;
...
TEST_CASE("p4: four momentum", "[p4][kinematics]") {
  using namespace edm4hep;
