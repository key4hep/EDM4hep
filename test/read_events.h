...
#if PODIO_BUILD_VERSION > PODIO_VERSION(1, 5, 0)
...
#define CHECK_COLL(COLL, NAME)                                                                                         \
  ...
  CHECK_COLL(sccons, "SimCalorimeterHitContributions")
  CHECK_COLL(schs, "SimCalorimeterHits")
  CHECK_COLL(tpchs, "TPCHits")
  CHECK_COLL(thps, "TrackerHitPlanes")
